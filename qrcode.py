    ...
    def gerar(self, cr, op_cr, nivel, op_nivel, empresa, tipos):
        try:
            if cr != '':
                ...
                self.nomeCR = nomeCR
                print(cr, op_cr, nivel, op_nivel, tipos)
...
if __name__ == '__main__':
    qr = QRCode('guilherme.breve','84584608@Gui')
    print(qr.gerar(cr=42636, op_cr='LIKE', op_nivel=3, nivel='>=', empresa='Grupo GPS', tipos='Locais'))
